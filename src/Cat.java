...
public class Cat {
	...
	private static final int MOUTH_WIDTH = 15;
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		g2.drawString("I don't even know what I am anymore.", catX, catY+HEAD_DIMENSION+10);	
		g2.drawString("Existance is pain.",catX, catY+HEAD_DIMENSION+25);
		g2.drawString("I just wanna die!",catX, catY+HEAD_DIMENSION+40);
